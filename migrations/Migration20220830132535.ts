...
export class Migration20220830132535 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "clients" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "first_name" varchar(40) not null, "middle_name" varchar(40) not null, "last_name" varchar(40) not null, "age" smallint not null, "bod" date not null, "address_unit" varchar(40) null, "address_street" varchar(60) null, "address1" varchar(60) not null, "address2" varchar(60) null, "suburb" varchar(40) null, "state" varchar(40) not null, "zip" varchar(40) not null, "country" varchar(40) not null, "photo" varchar(255) null, "cover_photo" varchar(255) null, "user_id" varchar(255) null, constraint "clients_pkey" primary key ("id"));');
    ...
    this.addSql('alter table "clients" add constraint "clients_user_id_foreign" foreign key ("user_id") references "users" ("id") on update cascade on delete cascade;');
  }
